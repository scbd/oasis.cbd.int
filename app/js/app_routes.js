...
app.config(["$routeProvider", '$locationProvider', function ($routeProvider, $locationProvider) {
    ...
    $routeProvider.
        ...
        when('/translation',                            { ...mapView(angularViewWrapper), label:'Translation',        resolveUser : true, resolve : { ...routeTemplates.views_translation_index    , securized : securize([ROLES.ADMINISTRATOR, ROLES.OASIS_ARTICLE_EDITOR],null, true) }}).
        when('/translation/project/:repository',        { ...mapView(angularViewWrapper), label:'Projects',           resolveUser : true, resolve : { ...routeTemplates.views_translation_project  , securized : securize([ROLES.ADMINISTRATOR, ROLES.OASIS_ARTICLE_EDITOR],null, true) }}).
                
        when('/translation/database-tables/:table',     { redirectTo : '/translation/database-tables/:table/export/' }).
        when('/translation/database-tables',            { ...mapView(angularViewWrapper), label:'Database Tables',        resolveUser : true, resolve : { ...routeTemplates.views_translation_database , securized : securize([ROLES.ADMINISTRATOR, ROLES.OASIS_ARTICLE_EDITOR],null, true) }}).
        when('/translation/database-tables/:table/export',{ ...mapView(angularViewWrapper), label:'Export for Translation',      resolveUser : true, resolve : { ...routeTemplates.views_translation_table          , securized : securize([ROLES.ADMINISTRATOR, ROLES.OASIS_ARTICLE_EDITOR],null, true) }}).
        when('/translation/database-tables/:table/import',{ ...mapView(vueViewWrapper),     label:'Import from Translation',     resolveUser : true, resolve : { ...routeTemplates.views_translation_table_import   , securized : securize([ROLES.ADMINISTRATOR, ROLES.OASIS_ARTICLE_EDITOR],null, true) }}).
        ...
        when('/articles/new',                           { ...mapView(angularViewWrapper), label:'Article Editor',     resolveUser : true, resolve : { ...routeTemplates.views_article_editor       , securized : securize([ROLES.ADMINISTRATOR, ROLES.OASIS_ARTICLE_EDITOR],null, true) }, isNew:true }).
        when('/articles/:id/:title?/edit',              { ...mapView(angularViewWrapper), label:'Article Editor',     resolveUser : true, resolve : { ...routeTemplates.views_article_editor       , securized : securize([ROLES.ADMINISTRATOR, ROLES.OASIS_ARTICLE_EDITOR],null, true) }}).
        ...
        when('/widgets/new',                            { ...mapView(angularViewWrapper), label:'New',                resolveUser : true, resolve : { ...routeTemplates.views_widgets_edit         , securized : securize([ROLES.ADMINISTRATOR, ROLES.OASIS_ARTICLE_EDITOR],null, true) }, isNew:true }).
        when('/widgets/:id/edit',                       { ...mapView(angularViewWrapper), label:'Edit',               resolveUser : true, resolve : { ...routeTemplates.views_widgets_edit         , securized : securize([ROLES.ADMINISTRATOR, ROLES.OASIS_ARTICLE_EDITOR],null, true) }}).
        ...
        // when('/manage/:schema',                         { ...mapView(angularViewWrapper), label:'Article Editor',     resolveUser : true, resolve : { ...routeTemplates.views_tags_index           , securized : securize([ROLES.ADMINISTRATOR, ROLES.OASIS_ARTICLE_EDITOR],null, true) }}).
        ...
        when('/clearing-house',                             { "redirectTo": '/clearing-house/realms'}).
        when('/clearing-house/records/failed-workflows',    { ...mapView(angularViewWrapper), label:'Failed Workflows'         ,   resolveUser : true, resolve : { ...routeTemplates.views_workflows_index      , securized : securize([...chmAdminRoles, ROLES.ADMINISTRATOR, ROLES.OASIS_WORK_FLOW_MANAGER], null, true) }}).
        when('/clearing-house/records/history/:identifier?',{ ...mapView(vueViewWrapper)    , label:'Record History'           ,   resolveUser : true, resolve : { ...routeTemplates.views_chm_record_history   , securized : securize([...chmAdminRoles, ROLES.ADMINISTRATOR], null, true) }}).
        when('/clearing-house/records/:environment?/:realm?/:schema?/:government?'     ,{ ...mapView(vueViewWrapper)    , label:'Records'                  ,   resolveUser : true, resolve : { ...routeTemplates.views_chm_records          , securized : securize([...chmAdminRoles, ROLES.ADMINISTRATOR], null, true) }, reloadOnUrl:false}).        
        when('/clearing-house/realms/:environment?',        { ...mapView(vueViewWrapper)    , label:'Clearing-House Management',   resolveUser : true, resolve : { ...routeTemplates.views_chm_index            , securized : securize([...chmAdminRoles, ROLES.ADMINISTRATOR], null, true) }}).
        when('/clearing-house/realms/:environment/list',    { ...mapView(vueViewWrapper)    , label:'Realms'                   ,   resolveUser : true, resolve : { ...routeTemplates.views_chm_realm_list       , securized : securize([...chmAdminRoles, ROLES.ADMINISTRATOR], null, true) }}).        
        when('/clearing-house/realms/:environment/:realm',  { ...mapView(vueViewWrapper)    , label:'Realm Details'            ,   resolveUser : true, resolve : { ...routeTemplates.views_chm_realm_details    , securized : securize([...chmAdminRoles, ROLES.ADMINISTRATOR], null, true) }}).        
