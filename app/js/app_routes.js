...
app.config(["$routeProvider", '$locationProvider', function ($routeProvider, $locationProvider) {
    ...
    $routeProvider.
        ...
        // clearing-house/:environment? route is interfering with specific paths
        ...
        when('/clearing-house/:environment?'                              ,{ ...mapView(vueViewWrapper)    , label:'Clearing-House Management',   resolveUser : true, resolve : { ...routeTemplates.views_chm_index            , securized : securize([...chmAdminRoles, 'Administrator'], null, true) }}).
