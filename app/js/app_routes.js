...
define(['app', 'lodash', 'js/extended-route-provider', 'services/app-config-service', 'scbd-angularjs-filters'], function (app, _) {
    ...
    app.config(['extendedRouteProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
        ...
        $routeProvider.
               ...
               when('/widgets/:id/:title?/edit',   { templateUrl: 'views/widgets/edit.html'  , label:'Edit',    resolveController: true, resolveUser : true, resolve : { securized : securize(['Administrator', 'oasisArticleEditor'],null, true) }}).
               when('/widgets/:id/:title?',        { templateUrl: 'views/widgets/view.html',   label:'Preview', resolveController: true, resolveUser : true, resolve : { securized : securize(null,null, true) }}).
