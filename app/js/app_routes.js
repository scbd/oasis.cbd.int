...
app.config(["$routeProvider", '$locationProvider', function ($routeProvider, $locationProvider) {
    ...
    $routeProvider.
        ...
        when('/clearing-house/records/:environment?/:realm?/:schema?'     ,{ ...mapView(vueViewWrapper)    , label:'Records'                  ,   resolveUser : true, resolve : { ...routeTemplates.views_chm_records          , securized : securize([...chmAdminRoles, 'Administrator'], null, true) }, reloadOnUrl:false}).        
